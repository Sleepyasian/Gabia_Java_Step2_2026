...
public class FileCopyMain_08 {
    ...
    public static void copyWithoutBuffer(String source, String dest) {
        ...
        FileOutputStream fos = new FileOutputStream(dest))
        {
            ...
            System.out.println("파일 복사중 오류 발생: " + e.getMessage());
        }
    }
    ...
    public static void main(String[] args) {
        ...
        long durationWithOutBuffer1 = endTime1 - startTime1;
		System.out.println("버퍼 사용하고 복사시 소요 시간: " + durationWithOutBuffer1 / 1_000_000 + "ms");
...
//원본파일 생성
    public static void createTestFile(String filepath, int sizeInBytes){
        try(BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream(filepath))) {
            ...
            System.out.println("파일 생성중 오류 발생: " + e.getMessage());
        }
